...
<div class="col-md-6">
<div class="col-md-6">
<input id="email" type="text" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ old('job_title') }}" required autocomplete="job_title" autofocus placeholder="Enter job title" >
...
<div class="col-md-6">
<div class="col-md-6">
<input id="email" type="password" class="form-control @error('password1') is-invalid @enderror" name="password1" value="{{ old('password1') }}" required autocomplete="password1" autofocus placeholder="confirm your password" >
